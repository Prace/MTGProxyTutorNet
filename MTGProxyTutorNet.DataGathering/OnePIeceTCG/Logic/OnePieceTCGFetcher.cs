...
namespace MTGProxyTutorNet.DataGathering.OnePIeceTCG.Logic
{
    public class OnePieceTCGFetcher : ICardDataFetcher
    {
        ...
        private readonly OnePieceDataConsumer _onePieceDataConsumer;
        private readonly IWebApiConsumer _webApiConsumer;
        private readonly ILogger _logger;
        private readonly IMapper _mapper;

        public OnePieceTCGFetcher(OnePieceDataConsumer onePieceDataConsumer, IWebApiConsumer webApiConsumer, ILogger logger, IMapper mapper)
        {
